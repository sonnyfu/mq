...
public class TopicDurableConsumer {
    ...
    public static void main(String[] args) {
         ...
         */
    	TopicDurableConsumer consumer1 = new TopicDurableConsumer();
        consumer1.doReceive();
...
//        consumer2.doReceive();
    ...
    public void doReceive() {
        try {
            ...
            connection.setClientID("macpro");
            connection.start();
            session = connection.createSession(true, Session.AUTO_ACKNOWLEDGE);
            destination = session.createTopic(TopicProducer.TOPIC_NAME);
            messageConsumer = session.createDurableSubscriber(destination, TopicProducer.TOPIC_NAME);
